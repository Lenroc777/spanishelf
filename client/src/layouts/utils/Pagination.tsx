...
export const Pagination: React.FC<{ currentPage: number, totalPages: number, paginate: any }> = (props) => {
    ...
    //create array of pages which should be displayed, depended on current page
            ...
            <ul className="pagination">
                ...
                </li>
                {
                    pageNumbers.map(number => (
                        //console.log(number)
                        <li key={number} onClick={() => props.paginate(number)} className={'page-item' + (props.currentPage === number ? ' active' : '')}> {/* if current page equals to number, add 'active' class */}
