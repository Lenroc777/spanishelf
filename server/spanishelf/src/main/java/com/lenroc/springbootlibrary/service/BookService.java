package com.lenroc.springbootlibrary.service;

import com.lenroc.springbootlibrary.entity.Book;
import com.lenroc.springbootlibrary.entity.Checkout;
import com.lenroc.springbootlibrary.entity.History;
import com.lenroc.springbootlibrary.entity.Payment;
import com.lenroc.springbootlibrary.repository.BookRepository;
import com.lenroc.springbootlibrary.repository.CheckoutRepository;
import com.lenroc.springbootlibrary.repository.HistoryRepository;
...
public class BookService {
    ...
    public void renewLoan(String userEmail, Long bookId) throws Exception {
        Checkout validateCheckout = checkoutRepository.findByUserEmailAndBookId(userEmail, bookId);
        if(validateCheckout == null) throw new Exception("Book does not exist or not checked out by the user");
